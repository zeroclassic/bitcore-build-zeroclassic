...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-zeroclassic/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:' + fullname + ' --external bitcore-lib-zeroclassic -o ' + fullname + '.js';
    } else {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:bitcore-lib-zeroclassic -o bitcore-lib-zeroclassic.js';
    }
